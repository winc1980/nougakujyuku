{
  let targets = document.querySelectorAll('.img_2,.img_3,.img_4'); //アニメーションさせたい要素
      //スクロールイベント
  ...
  let targets_ = document.querySelectorAll('.small_eclipse1,.small_eclipse2,.big_eclipse,.medium_eclipse'); //アニメーションさせたい要素
      //スクロールイベント
      window.addEventListener('scroll', function () {
        var scroll = window.scrollY; //スクロール量を取得
        var windowHeight = window.innerHeight; //画面の高さを取得
      ...
      let _targets_ = document.querySelectorAll('.keyword1,.keyword2');
